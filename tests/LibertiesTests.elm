    ...
    describe "Liberties"
        [ test "Find 3 liberties basic example" <|
            \_ ->
                let
                    liberties =
                        findLiberties ( Black, { x = 560, y = 314 } )
                            [ ( White, { x = 561, y = 234 } ) -- up
                            , ( White, { x = 635, y = 331 } ) -- lower right
                            , ( White, { x = 653, y = 415 } ) -- lower right further
                            , ( White, { x = 505, y = 368 } ) -- lower left
                            , ( White, { x = 543, y = 455 } ) -- lower left further
                            ]
                in
                case liberties of
                    a :: b :: c :: [] ->
